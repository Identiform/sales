...
const SetParams = Async(() => import('./admin/SetParams'))
const ManageICO = Async(() => import('./admin/ManageICO'))
const SetRate = Async(() => import('./admin/SetRate'))
const Wrapper = Async(() => import('./template/Wrapper'))
